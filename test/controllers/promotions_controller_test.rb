...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { date: @promotion.date, description: @promotion.description, number: @promotion.number, title: @promotion.title }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { date: @promotion.date, description: @promotion.description, number: @promotion.number, title: @promotion.title }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
